...
ALTER TABLE ONLY public.delegation_providers
    ADD CONSTRAINT delegation_providers_delegation_id_fk FOREIGN KEY (delegation_id) REFERENCES public.delegations(id);

ALTER TABLE ONLY public.delegation_providers
    ADD CONSTRAINT delegation_providers_providers_id_fk FOREIGN KEY (provider_id) REFERENCES public.providers(id);
